...
MESSAGE="mailtestdesu"
STATUS="OK"

MAIL_SUBJECT="[${MESSAGE}]:"
RESULT_TEXT="[${MESSAGE}] ${STATUS}"

/usr/bin/python2 - $SMTP_HOST $SMTP_PORT $SMTP_USER $SMTP_PASSWD "$MAIL_SUBJECT" "$RESULT_TEXT" $MAIL_FROM ${MAIL_TO_LIST[@]} << EOF
